...
internal abstract partial class FARunner : Object, IEnumerable<FAMatch>
{
	...
	public IEnumerator<FAMatch> IEnumerable<FAMatch>.GetEnumerator() { return new Enumerator(this); }
...
{
	public static bool UsingSpans { get { return true; } }
	...
	protected void Advance(ReadOnlySpan<Char> span, ref int ch, ref int len, bool first)
	{
		if (!first)
		{
			if (ch == 10)
